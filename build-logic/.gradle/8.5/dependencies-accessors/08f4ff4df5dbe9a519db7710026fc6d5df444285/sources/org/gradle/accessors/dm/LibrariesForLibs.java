...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxCoreLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxSplashScreen'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxHiltLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'androidxNavigationHilt'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class FirebaseCrashlyticsGradleLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'firebaseCrashlyticsPlugin'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPlugin() {
    ...
    public static class FirebasePerformanceGradleLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'firebasePerfPlugin'.
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPlugin() {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidxComposeCompiler (1.5.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
        private final KotlinParcelizePluginAccessors paccForKotlinParcelizePluginAccessors = new KotlinParcelizePluginAccessors(providers, config);
        private final KotlinSerializationPluginAccessors paccForKotlinSerializationPluginAccessors = new KotlinSerializationPluginAccessors(providers, config);

        public KotlinPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of plugins at plugins.kotlin.parcelize
         */
        public KotlinParcelizePluginAccessors getParcelize() {
            return paccForKotlinParcelizePluginAccessors;
        }

        /**
         * Returns the group of plugins at plugins.kotlin.serialization
         */
        public KotlinSerializationPluginAccessors getSerialization() {
            return paccForKotlinSerializationPluginAccessors;
        }

    }

    public static class KotlinParcelizePluginAccessors extends PluginFactory {

        public KotlinParcelizePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for kotlin.parcelize.plugin to the plugin id 'org.jetbrains.kotlin.plugin.parcelize'
             * with versionRef 'kotlin'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getPlugin() { return createPlugin("kotlin.parcelize.plugin"); }

    }

    public static class KotlinSerializationPluginAccessors extends PluginFactory {

        public KotlinSerializationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Creates a plugin provider for kotlin.serialization.plugin to the plugin id 'org.jetbrains.kotlin.plugin.serialization'
             * with versionRef 'kotlin'.
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getPlugin() { return createPlugin("kotlin.serialization.plugin"); }
